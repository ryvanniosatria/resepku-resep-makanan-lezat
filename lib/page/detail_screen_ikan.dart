...
class _DetailScreenIkanState extends State<DetailScreenIkan> {
  ...
  Future<void> showCustomSnackBar(String message) async {
    ...
    Future<void> shareResep(ModelIkan resep) async {
  ...
  Future<void> simpanResep() async {
    ...
    await showCustomSnackBar('Resep ${widget.ikan.nama} telah disimpan');
  ...
  Future<void> hapusResep() async {
    ...
    await showCustomSnackBar('Resep ${widget.ikan.nama} telah dihapus');
    // Tambahkan pesan log atau penanganan lain yang diperlukan
