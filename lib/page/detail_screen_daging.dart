...
class _DetailScreenDagingState extends State<DetailScreenDaging> {
  ...
  Future<void> showCustomSnackBar(String message) async {
    ...
    Future<void> shareResep(ModelDaging resep) async {
  ...
  Future<void> simpanResep() async {
    ...
    await showCustomSnackBar('Resep ${widget.daging.nama} telah disimpan');
  ...
  Future<void> hapusResep() async {
    ...
    await showCustomSnackBar('Resep ${widget.daging.nama} telah dihapus');
    // Tambahkan pesan log atau penanganan lain yang diperlukan
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: widget.daging.langkah!
                  .asMap()
                  .map((index, langkah) =>
